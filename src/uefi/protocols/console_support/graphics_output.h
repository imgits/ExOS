...
using EFI_GRAPHICS_OUTPUT_PROTOCOL_SET_MODE = EFIAPI EFI_STATUS (*)
(EFI_GRAPHICS_OUTPUT_PROTOCOL *This,
 UINT32 ModeNUmber);
...
using EFI_GRAPHICS_OUTPUT_PROTOCOL_BLT = EFIAPI EFI_STATUS (*)
(EFI_GRAPHICS_OUTPUT_PROTOCOL *This,
...
using EFI_EDID_OVERRIDE_PROTOCOL_GET_EDID = EFIAPI EFI_STATUS (*)

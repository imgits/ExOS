...
using EFI_INPUT_RESET_EX = EFIAPI EFI_STATUS (*)
...
using EFI_INPUT_READ_KEY_EX = EFIAPI EFI_STATUS (*)
(EFI_SIMPLE_TEXT_INPUT_EX_PROTOCOL *This,
 EFI_KEY_DATA *KeyData);

using EFI_SET_STATE = EFIAPI EFI_STATUS (*)
(EFI_SIMPLE_TEXT_INPUT_EX_PROTOCOL *This,
 EFI_KEY_TOGGLE_STATE *KeyToggleState);

using EFI_KEY_NOTIFY_FUNCTION = EFIAPI EFI_STATUS (*)
(EFI_KEY_DATA *KeyData);

using EFI_REGISTER_KEYSTROKE_NOTIFY = EFIAPI EFI_STATUS (*)
(EFI_SIMPLE_TEXT_INPUT_EX_PROTOCOL *This,
 EFI_KEY_DATA *KeyData,
 EFI_KEY_NOTIFY_FUNCTION KeyNotificationFunction,
 VOID **NotifyHandle);

using EFI_UNREGISTER_KEYSTROKE_NOTIFY = EFIAPI EFI_STATUS (*)
(EFI_SIMPLE_TEXT_INPUT_EX_PROTOCOL *This,

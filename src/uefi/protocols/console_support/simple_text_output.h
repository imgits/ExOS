...
using EFI_TEXT_RESET = EFIAPI EFI_STATUS (*)
(EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *This,
 BOOLEAN ExtendedVerification);

using EFI_TEXT_STRING = EFIAPI EFI_STATUS (*)
(EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *This,
 CHAR16 *String);
...
using EFI_TEXT_TEST_STRING = EFIAPI EFI_STATUS (*)
(EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *This,
 CHAR16 *String);

using EFI_TEXT_QUERY_MODE = EFIAPI EFI_STATUS (*)
(EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *This,
 UINTN ModeNumber,
 UINTN *Column,
 UINTN *Rows);

using EFI_TEXT_SET_MODE = EFIAPI EFI_STATUS (*)
(EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *This,
 UINTN ModeNumber);

using EFI_TEXT_SET_ATTRIBUTE = EFIAPI EFI_STATUS (*)
(EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *This,
 UINTN Attribute);
...
using EFI_TEXT_CLEAR_SCREEN = EFIAPI EFI_STATUS (*)
(EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *This);

using EFI_TEXT_SET_CURSOR_POSITION = EFIAPI EFI_STATUS (*)
(EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *This,
 UINTN Column,
 UINTN Row);

using EFI_TEXT_ENABLE_CURSOR = EFIAPI EFI_STATUS (*)
(EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *This,
 BOOLEAN Visible);

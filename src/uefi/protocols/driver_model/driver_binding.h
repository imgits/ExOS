...
using EFI_DRIVER_BINDING_PROTOCOL_SUPPORTED = EFIAPI EFI_STATUS (*)
(EFI_DRIVER_BINDING_PROTOCOL *This,
 EFI_HANDLE ControllerHandle,
 EFI_DEVICE_PATH_PROTOCOL *RemainingDevicePath);

using EFI_DRIVER_BINDING_PROTOCOL_START = EFIAPI EFI_STATUS (*)
(EFI_DRIVER_BINDING_PROTOCOL *This,
 EFI_HANDLE ControllerHandle,
 EFI_DEVICE_PATH_PROTOCOL *RemainingDevicePath);

using EFI_DRIVER_BINDING_PROTOCOL_STOP = EFIAPI EFI_STATUS (*)
(EFI_DRIVER_BINDING_PROTOCOL *This,
 EFI_HANDLE ControllerHandle,

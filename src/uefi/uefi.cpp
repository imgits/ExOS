...
EFI_STATUS
Uefi::get_memory_map(EFI_BOOT_SERVICES const &bs, Uefi::MemoryMap &map)
{
...
StringRefUefi Uefi::status_to_string(EFI_STATUS status)
{
    ...
    case EFI_SUCCESS:
        return u"Success"_s;
    case EFI_LOAD_ERROR:
        return u"Load error"_s;
    case EFI_INVALID_PARAMETER:
        return u"Invalid parameter"_s;
    case EFI_UNSUPPORTED:
        return u"Unsupported"_s;
    case EFI_BAD_BUFFER_SIZE:
        return u"Bad buffer size"_s;
    case EFI_BUFFER_TOO_SMALL:
        return u"Buffer too small"_s;
    case EFI_NOT_READY:
        return u"Not ready"_s;
    case EFI_DEVICE_ERROR:
        return u"Device error"_s;
    case EFI_WRITE_PROTECTED:
        return u"Write protected"_s;
    case EFI_OUT_OF_RESOURCES:
        return u"Out of resources"_s;
    case EFI_VOLUME_CORRUPTED:
        return u"Volume corrupted"_s;
    case EFI_VOLUME_FULL:
        return u"Volume full"_s;
    case EFI_NO_MEDIA:
        return u"No media"_s;
    case EFI_MEDIA_CHANGED:
        return u"Media changed"_s;
    case EFI_NOT_FOUND:
        return u"Not found"_s;
    case EFI_ACCESS_DENIED:
        return u"Access denied"_s;
    case EFI_NO_RESPONSE:
        return u"No response"_s;
    case EFI_NO_MAPPING:
        return u"No mapping"_s;
    case EFI_TIMEOUT:
        return u"Timeout"_s;
    case EFI_NOT_STARTED:
        return u"Not started"_s;
    case EFI_ALREADY_STARTED:
        return u"Already started"_s;
    case EFI_ABORTED:
        return u"Aborted"_s;
    case EFI_ICMP_ERROR:
        return u"ICMP error"_s;
    case EFI_TFTP_ERROR:
        return u"TFTP error"_s;
    case EFI_PROTOCOL_ERROR:
        return u"Protocol error"_s;
    case EFI_INCOMPATIBLE_VERSION:
        return u"Incompatible version"_s;
    case EFI_SECURITY_VIOLATION:
        return u"Security violation"_s;
    case EFI_CRC_ERROR:
        return u"CRC error"_s;
    case EFI_END_OF_MEDIA:
        return u"End of media"_s;
    case EFI_END_OF_FILE:
        return u"End of file"_s;
    case EFI_INVALID_LANGUAGE:
        return u"Invalid language"_s;
    case EFI_COMPROMISED_DATA:
        return u"Compromised data"_s;
    case EFI_IP_ADDRESS_CONFLICT:
        return u"IP address conflict"_s;
    case EFI_WARN_UNKNOWN_GLYPH:
        return u"Unknown glyph"_s;
    case EFI_WARN_DELETE_FAILURE:
        return u"Delete failure"_s;
    case EFI_WARN_WRITE_FAILURE:
        return u"Write failure"_s;
    case EFI_WARN_BUFFER_TOO_SMALL:
        return u"Buffer too small"_s;
    case EFI_WARN_STALE_DATA:
        return u"Stale data"_s;
    }
}

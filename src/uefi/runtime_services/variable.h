...
using EFI_GET_VARIABLE = EFIAPI EFI_STATUS (*)
(CHAR16 *VariableName,
 EFI_GUID *VendorGuid,
 UINT32 *Attributes,
 UINTN *DataSize,
...
constexpr UINT32 EFI_VARIABLE_TIME_BASED_AUTHENTICATED_WRITE_ACCESS = 0x00000020;
constexpr UINT32 EFI_VARIABLE_APPEND_WRITE = 0x00000040;

using EFI_GET_NEXT_VARIABLE_NAME = EFIAPI EFI_STATUS (*)
(UINTN *VariableNameSize,
 CHAR16 *VariableName,
 EFI_GUID VendorGuid);

using EFI_SET_VARIABLE = EFIAPI EFI_STATUS (*)
(CHAR16 *VariableName,
 EFI_GUID *VendorGuid,
 UINT32 Attributes,
 UINTN DataSize,
...
using EFI_QUERY_VARIABLE_INFO = EFIAPI EFI_STATUS (*)
(UINT32 Attributes,

...
using EFI_RESET_SYSTEM = EFIAPI VOID (*)
(EFI_RESET_TYPE ResetType,
 EFI_STATUS ResetStatus,
 UINTN DataSize,
 VOID *ResetData);

using EFI_GET_NEXT_HIGH_MONO_COUNT = EFIAPI EFI_STATUS (*)
(UINT32 *HighCount);
...
using EFI_UPDATE_CAPSULE = EFIAPI EFI_STATUS (*)
...
using EFI_QUERY_CAPSULE_CAPABILITIES = EFIAPI EFI_STATUS (*)
(EFI_CAPSULE_HEADER **CapsuleHeaderArray,
 UINTN CapsuleCount,
...
constexpr UINT64 EFI_OS_INDICATIONS_FILE_CAPSULE_DELIVERY_SUPPORTED = 0x0000000000000004;
constexpr UINT64 EFI_OS_INDICATIONS_FMP_CAPSULE_SUPPORTED = 0x0000000000000008;
constexpr UINT64 EFI_OS_INDICATIONS_CAPSULE_RESULT_VAR_SUPPORTED = 0x0000000000000010;

...
struct Cr0
{
    ...
    std::uint64_t extension_type : 1; // read only
    ...
    std::uint64_t not_writethrough : 1;
...
struct Cr2
{
    std::uint64_t page_fault_virtual_address;
};
...
struct Cr3
{
    ...
    std::uint64_t page_map_level_4_table_base_address : 40;
...
struct Cr4
{
    ...
    std::uint64_t operating_system_fxsave_fxrstor_support : 1;
    std::uint64_t operating_system_unmasked_exceptions_support : 1;
    std::uint64_t reserved : 5;
    std::uint64_t fsgsbase : 1;
    std::uint64_t reserved2 : 1;
    std::uint64_t osxsave : 1;
    std::uint64_t reserved3 : 45;
};
...
struct Rflags
{
    ...
    std::uint64_t parity : 1;
    std::uint64_t reserved2 : 1;
    std::uint64_t auxiliary : 1;
    std::uint64_t reserved3 : 1;
    std::uint64_t zero : 1;
    std::uint64_t sign : 1;
    std::uint64_t trap : 1;
    std::uint64_t interrupt : 1;
    std::uint64_t direction : 1;
    std::uint64_t overflow : 1;
    std::uint64_t io_privilege_level : 2;
    std::uint64_t nested_task : 1;
    std::uint64_t reserved4 : 1;
    std::uint64_t resume : 1;
    std::uint64_t virtual_8086_mode : 1;
    std::uint64_t alignment_check : 1;
    std::uint64_t virtual_interrupt : 1;
    std::uint64_t virtual_interrupt_pending : 1;
    std::uint64_t id : 1;
    std::uint64_t reserved5 : 42;
};

struct Efer
{
    std::uint64_t system_call_extensions : 1;
    std::uint64_t reserved : 7;
    std::uint64_t long_mode_enable : 1;
    std::uint64_t reserved : 1;
    std::uint64_t long_mode_active : 1;
    std::uint64_t no_execute_enable : 1;
    std::uint64_t secure_virtual_machine_enable : 1;
    std::uint64_t long_mode_segment_limit_enable : 1;
    std::uint64_t fast_fxsave_fxrstor : 1;
    std::uint64_t translation_cache_extensions : 1;

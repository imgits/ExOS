...
[[noreturn]] SYSV_ABI void
intr_double_fault_cpp(Interrupts::StackNoErrorCode const *stack)
{
    (void)stack;
...
[[noreturn]] SYSV_ABI void
intr_invalid_tss_cpp(Interrupts::StackNoErrorCode const *stack)
{
    (void)stack;
...
[[noreturn]] SYSV_ABI void
intr_segment_not_present_cpp(Interrupts::StackNoErrorCode const *stack)
{
    (void)stack;
...
[[noreturn]] SYSV_ABI void
intr_stack_cpp(Interrupts::StackNoErrorCode const *stack)
{
    (void)stack;
...
[[noreturn]] SYSV_ABI void
intr_general_protection_cpp(Interrupts::StackNoErrorCode const *stack)
{
    (void)stack;
...
[[noreturn]] SYSV_ABI void
intr_page_fault_cpp(Interrupts::StackNoErrorCode const *stack)
{
    (void)stack;
...
[[noreturn]] SYSV_ABI void
intr_alignment_check_cpp(Interrupts::StackNoErrorCode const *stack)
{
    (void)stack;
